...
const AttendeeForm = () => {
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6 h-fit">
      <h2 className="font-display text-base font-semibold text-[var(--text)] mb-1">Register Attendee</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" placeholder="Sahina" value={name} onChange={(e) => setName(e.target.value)} className={inputClass} required />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-xs font-medium text-[var(--text-muted)] mb-1.5">College</label>
            <input type="text" placeholder="Optional" value={college} onChange={(e) => setCollege(e.target.value)} className={inputClass} />
          </div>
          <div>
            <label className="block text-xs font-medium text-[var(--text-muted)] mb-1.5">Department</label>
            <input type="text" placeholder="Optional" value={department} onChange={(e) => setDepartment(e.target.value)} className={inputClass} />
          </div>
        </div>
